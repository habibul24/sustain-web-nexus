...
const SOURCES = [
  { name: 'Electricity purchased HK Electric', unit: 'KWh' },
  { name: 'Electricity purchased (CLP)', unit: 'KWh' },
  { name: 'Towngas purchased', unit: 'units' },
];
...
const Scope2 = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-2xl md:text-3xl font-bold mb-4">Scope 2 Carbon Emission Calculations</h1>
      <Accordion type="single" collapsible defaultValue="info" className="mb-6">
        <AccordionItem value="info">
          <AccordionTrigger className="text-base font-semibold">What are Scope 2 emissions?</AccordionTrigger>
          <AccordionContent>
            <div className="text-gray-700">
              Scope 2 emissions are GHG emissions from the generation of purchased electricity that is consumed in your Company's owned or controlled equipment. Scope 2 emissions are considered indirect because they occur at the facility where the electricity is generated, but the energy produced is used by you.
            </div>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
